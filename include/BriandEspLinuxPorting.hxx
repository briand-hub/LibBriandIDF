 ...
 */
		...
		#define ESP_LOGV(tag, _format, ...) { if(BRIAND_CURRENT_LOG_LEVEL >= ESP_LOG_VERBOSE) { printf("I "); printf(tag); printf(" "); printf(_format, ##__VA_ARGS__); } }
		#define ESP_LOGD(tag, _format, ...) { if(BRIAND_CURRENT_LOG_LEVEL >= ESP_LOG_DEBUG) { printf("I "); printf(tag); printf(" "); printf(_format, ##__VA_ARGS__); } }
		#define ESP_LOGE(tag, _format, ...) { if(BRIAND_CURRENT_LOG_LEVEL >= ESP_LOG_ERROR) { printf("I "); printf(tag); printf(" "); printf(_format, ##__VA_ARGS__); } }
		#define ESP_LOGW(tag, _format, ...) { if(BRIAND_CURRENT_LOG_LEVEL >= ESP_LOG_WARN) { printf("I "); printf(tag); printf(" "); printf(_format, ##__VA_ARGS__); } }
