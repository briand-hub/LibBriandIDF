 ...
 */
		...
		#define IP_EVENT_STA_GOT_IP "IP_EVENT_STA_GOT_IP"
		#define IP_EVENT_STA_LOST_IP "IP_EVENT_STA_LOST_IP"
		#define WIFI_EVENT_STA_DISCONNECTED "WIFI_EVENT_STA_DISCONNECTED"
		#define WIFI_EVENT_STA_START "WIFI_EVENT_STA_START"
		#define WIFI_EVENT_AP_STACONNECTED "WIFI_EVENT_AP_STACONNECTED"
		#define WIFI_EVENT_AP_STADISCONNECTED "WIFI_EVENT_AP_STADISCONNECTED"
		#define WIFI_EVENT_WIFI_READY "WIFI_EVENT_WIFI_READY"
